...
namespace UnityEngine.AddressableAssets
{
    ...
    public static partial class AddressablesManager
    {
        ...
        private static void OnInitializeCompleted(IResourceLocator handle)
        {
            _keys.AddRange(handle.Keys);
        }
            ...
            where T : Object
        {
            ...
            else
            {
                ...
                _instanceAdresses.Add(handle.Result, key);
            }
                                                   ...
                                                   Action<string> onFailed = null)
        {
            ...
            _instanceAdresses.Add(handle.Result, key); //Should assign the spawned obj to a relative address
            onSucceeded?.Invoke(key, handle.Result);
        }
                                                 ...
                                                 Action<string> onFailed = null)
        {
            if (handle.Status == AsyncOperationStatus.Succeeded)
            {
                ...
                _instanceAdresses.Add(handle.Result, key);  //Should assign the Loaded Scene to a relative address
