...
namespace Ruccho.Utilities
{
    ...
    public class FangAutoTileEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            tile.TileType = (TileType)EditorGUILayout.EnumPopup("TileType", tile.TileType);
    ...
    public class FangAutoTileTexturePreview : ObjectPreview
    {
        ...
        public override void OnPreviewGUI(Rect r, GUIStyle background)
        {
            if (tile.Texture)
            {
                ...
                //    EditorGUI.DrawTextureTransparent(r, previewTexture);
               // Editor e = Editor.CreateEditor(tile.Texture); WAS UNCOMMENTED
                //e.OnPreviewGUI(r, background); WAS UNCOMMENTED
